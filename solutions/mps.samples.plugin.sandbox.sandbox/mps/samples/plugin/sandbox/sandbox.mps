...
<model modelUID="r:5a94f2b1-84e1-4509-866e-eb0bacaf98bd(mps.samples.plugin.sandbox.sandbox)">
  <persistence version="3" />
  <refactoringHistory />
  <language namespace="681e5239-d663-468b-97f7-cc7a4fa4cdea(mps.sample.plugin)" />
  ...
  <node type="mps.sample.plugin.structure.Crowd" id="6833784181526701747">
    ...
    <node role="member" type="mps.sample.plugin.structure.Person" id="8369951910274493999">
      ...
      <property name="zip" value="4711" />
      <property name="city" value="Bar" />
    </node>
  </node>
</model>
